    ...
    <div className="min-w-fit">
      ...
      <div
        className={`fixed inset-0 bg-gray-900/30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
          sidebarOpen || sidebarExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
        aria-hidden="true"
      ></div>
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span
                      className={`text-sm font-medium ml-4 ${sidebarExpanded || sidebarOpen ? 'lg:opacity-100' : 'lg:opacity-0'} 2xl:opacity-100 duration-200`}
                    >
                      Admin
                    </span>
                  </div>
